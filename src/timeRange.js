...
let TimeRange = L.Control.extend({ 
    ...
    updateDesc: function (){
        ...
        this.desc.innerHTML = "Showing "+sectors_all[sectorSelector.value]+" businesses that are currently active (and they were<br>ALSO active, in the same location, at timeslice):";
    }
  });
